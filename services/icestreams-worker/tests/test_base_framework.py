...
class TestNodeInput:
    ...
    @pytest.mark.parametrize("valid_type", ["any", "string", "number", "bool", "object", "array"])
...
class TestNodeContext:
    ...
    def test_node_context_with_config_and_variables(self) -> None:
        ...
        assert context.variables == {"api_key": "secret", "endpoint": "https://api.test"}
    ...
    def test_get_config_value_returns_existing_key(self, valid_context: NodeContext) -> None:
    ...
    def test_get_config_value_returns_default_for_missing_key(self, valid_context: NodeContext) -> None:
        """Test get_config_value returns default for missing key."""
        assert valid_context.get_config_value("missing", "default") == "default"

    def test_get_variable_returns_existing_variable(self, valid_context: NodeContext) -> None:
    ...
    def test_get_variable_returns_default_for_missing(self, valid_context: NodeContext) -> None:
...
class TestNodeResult:
    ...
    def test_node_result_direct_creation_failure_requires_error(self) -> None:
        ...
        with pytest.raises(ValueError, match="Failed NodeResult must include an error message"):
