...
from ...auth import SAMLConfig, SAMLHandler, OIDCConfig, OIDCHandler, JITConfig, JITProvisioner
...
def saml_acs():
    ...
    try:
        ...
        user = provisioner.get_or_create_saml_user(
