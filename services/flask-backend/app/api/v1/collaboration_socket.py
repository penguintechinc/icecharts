...
from app.websocket import get_socketio
...
@socketio.on("request_collaborators")
...
# Register cleanup task (optional - can be called periodically)
@socketio.on("cleanup_inactive_sessions")
