...
const navItems = [
  ...
  { path: '/drawings', label: 'Drawings', icon: 'M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7m0 10a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2h-2a2 2 0 00-2 2' },
  { path: '/collections', label: 'Collections', icon: 'M3 7v10a2 2 0 002 2h14a2 2 0 002-2V7m0 0V5a2 2 0 00-2-2H5a2 2 0 00-2 2v2m0 0H3a2 2 0 00-2 2v10a2 2 0 002 2h18a2 2 0 002-2V7a2 2 0 00-2-2h-1' },
