/**
 * PlaybookCollections - Collections for organizing playbooks
 */

import React from 'react';
import { Link } from 'react-router-dom';

const PlaybookCollections: React.FC = () => {
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-white">Playbook Collections</h1>
          <p className="text-ice-navy-300 mt-1">
            Organize your playbooks into collections
          </p>
        </div>
      ...
      <div className="flex flex-col items-center justify-center min-h-[400px] bg-ice-navy-800/50 rounded-lg border border-ice-navy-700">
        ...
        <p className="text-ice-navy-400 mb-4 text-center max-w-md">
          Collections help you organize playbooks by project, team, or category.
          Playbook collections are separate from diagram collections.
        </p>
      ...
      <div className="mt-6 p-4 bg-blue-500/10 border border-blue-500/30 rounded-lg">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-blue-400 font-medium">Playbook collections are separate</p>
            <p className="text-ice-navy-300 text-sm mt-1">
              Playbook collections only contain playbooks. For diagram collections, visit the{' '}
              <Link to="/collections/diagrams" className="text-ice-gold-400 hover:underline">
                Charts Collections
              </Link>{' '}
              page.
            </p>
...
export default PlaybookCollections;
