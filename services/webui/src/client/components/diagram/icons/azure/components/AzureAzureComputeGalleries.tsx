...
const SvgAzureAzureComputeGalleries = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="b9a9ff0b-7dac-405b-a6dd-a489a2813f83"
        x1={8.898}
        y1={16.345}
        x2={8.898}
        y2={1.887}
      ...
      <g>
        <g>
          ...
          <rect
            ...
            height={14.458}
            rx={0.88}
            fill="url(#b9a9ff0b-7dac-405b-a6dd-a489a2813f83)"
          />
        </g>
        <g>
          <polygon
            points="12.097 7.198 12.097 10.802 9.004 12.612 9.004 9 12.097 7.198"
            fill="#50e6ff"
          />
          <polygon
            points="12.097 7.198 9.004 9.008 5.903 7.198 9.004 5.388 12.097 7.198"
            fill="#c3f1ff"
          />
          <polygon
            points="9.004 9.008 9.004 12.612 5.903 10.802 5.903 7.198 9.004 9.008"
            fill="#9cebff"
          />
...
const Memo = memo(SvgAzureAzureComputeGalleries);
export default Memo;
