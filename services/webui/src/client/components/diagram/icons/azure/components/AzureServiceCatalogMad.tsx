...
const SvgAzureServiceCatalogMad = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" {...props}>
    ...
    <path
      d="M1.93 2.1L3.15.7A.58.58 0 0 1 3.59.5h11.6a.81.81 0 0 1 .88.83v14.5a.6.6 0 0 1-.19.44l-1.3 1.2H2.72l-.8-.34z"
      fill="#773adc"
    />
    <path
      d="M2.9 2.1l.74-.85A.53.53 0 0 1 4 1.08h10.88a.52.52 0 0 1 .52.52v13.78a.52.52 0 0 1-.17.39l-1.15 1.05z"
      fill="#fff"
    />
    <path
      d="M14,2.1H2a0,0,0,0,0-.05,0v15a.39.39,0,0,0,.38.39H14a.39.39,0,0,0,.38-.39V2.48A.38.38,0,0,0,14,2.1Z"
    ...
    <g fill="#fff">
      ...
      <path d="M7 8l1.57-.85 1.6.85a.05.05 0 0 1 0 0l-1.56.85L7 8" opacity={0.8} />
      <path
        d="M5 6.87L6.52 6h.05l1.53.84a.05.05 0 0 1 0 .08l-1.55.85L5 6.93m4.08-.03l1.56-.9a0 0 0 0 1 0 0l1.53.84a.05.05 0 0 1 0 0 .08.08 0 0 1 0 0l-1.55.85h-.05L9.1 7a0 0 0 0 1 0 0M7 5.8l1.56-.84h.05l1.55.83a.05.05 0 0 1 0 0l-1.57.84L7 5.86"
        opacity={0.8}
      />
      <path
        d="M8.82 11.18l1.57-.87V8.5l-1.58.87a.05.05 0 0 0 0 0v1.75a.05.05 0 0 0 0 0zm3.63-3.86a0 0 0 0 0 0 0l-1.58.87a.05.05 0 0 0 0 0V10a.05.05 0 0 0 0 0h.05l1.57-.87a.05.05 0 0 0 0 0V7.36s-.02-.04-.04-.04zM9 12.2c.32 0 .65.1.67.5a.57.57 0 0 1 0 .23l.8-.33a.05.05 0 0 0 0 0v-1.8a.05.05 0 0 0 0 0l-1.58.87v.53zm3.4-2.58l-1.58.87v1.75a.05.05 0 0 0 0 0h.05l1.57-.87v-1.7z"
        opacity={0.6}
      />
...
const Memo = memo(SvgAzureServiceCatalogMad);
export default Memo;
