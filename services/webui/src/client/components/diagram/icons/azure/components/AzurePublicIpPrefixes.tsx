...
const SvgAzurePublicIpPrefixes = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      ...
      <linearGradient
        ...
        x2={9}
        y2={-1398.732}
        xlinkHref="#b6125be5-5e46-486d-bdee-ef1ac2eafdaa"
      />
      <linearGradient
    ...
    <g>
      <path
        d="M0,4.16H10.11V9.8a.34.34,0,0,1-.34.34H.34A.34.34,0,0,1,0,9.8H0V4.16Z"
        fill="url(#b6125be5-5e46-486d-bdee-ef1ac2eafdaa)"
      />
      ...
      <path
        d="M3.94,7.08H14.06v5.64a.34.34,0,0,1-.34.34H4.28a.34.34,0,0,1-.34-.34h0Z"
        fill="url(#adf1cfb9-1a2a-44ee-aac6-05ac5cdb186f)"
      />
      <path
        d="M4.28,4.93h9.43a.34.34,0,0,1,.34.34h0V7.08H3.95V5.27A.34.34,0,0,1,4.28,4.93Z"
        fill="#767676"
      />
      <rect x={5.3} y={5.58} width={7.39} height={0.87} rx={0.17} fill="#f2f2f2" />
      <g>
        <path
          d="M7.89,10.02H18v5.64a.34.34,0,0,1-.34.34H8.23a.34.34,0,0,1-.34-.34h0Z"
          fill="url(#f0461ac7-cb08-44b4-94c6-8fe04f936f9b)"
        />
        <path
          d="M8.23,7.86h9.43A.34.34,0,0,1,18,8.2v1.82H7.89V8.2A.34.34,0,0,1,8.23,7.86Z"
          fill="#767676"
        />
        <g>
...
const Memo = memo(SvgAzurePublicIpPrefixes);
export default Memo;
