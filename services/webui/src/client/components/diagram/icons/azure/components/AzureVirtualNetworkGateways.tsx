...
const SvgAzureVirtualNetworkGateways = (props: SVGProps<SVGSVGElement>) => (
  <svg
    id="b6f74ca5-3ae6-426f-9ef1-9ff6bbaa7f1c"
  ...
  >
    <defs>
      <linearGradient
        id="bd7305f8-8789-4600-a1f2-6594e60eefcc"
        x1={8.59}
        y1={-7.79}
        x2={9.12}
        y2={20.05}
    ...
    <path
      ...
      fill="url(#bd7305f8-8789-4600-a1f2-6594e60eefcc)"
    />
    <path
