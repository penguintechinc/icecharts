...
const SvgAzureCommunityImages = (props: SVGProps<SVGSVGElement>) => (
    ...
    <g id="ffc139e1-9759-4c62-86f0-fb6d6244ccb9">
      <g>
        ...
        <g>
          ...
          <g>
            <polygon
              points="8.397 7.262 8.418 10.702 5.481 12.447 5.46 9 8.397 7.262"
              fill="#50e6ff"
            />
            <polygon
              points="8.397 7.262 5.461 9.007 2.495 7.297 5.44 5.552 8.397 7.262"
              fill="#c3f1ff"
            />
            <polygon
              points="5.461 9.007 5.481 12.447 2.516 10.738 2.495 7.297 5.461 9.007"
              fill="#9cebff"
            />
...
const Memo = memo(SvgAzureCommunityImages);
export default Memo;
