...
const SvgAzureDevopsStarter = (props: SVGProps<SVGSVGElement>) => (
  <svg
    id="e00adf82-3a2b-4d63-88d6-04e0fd613716"
  ...
  >
    <defs>
      <linearGradient
        id="e3494492-9322-4864-b215-4b13d5db2a3c"
        x1={306.077}
        y1={-363.569}
        x2={305.834}
        y2={-351.67}
      ...
      <linearGradient
        id="f1488af2-2554-4dd5-a9ad-c1ce2894eaa1"
        x1={310.996}
        y1={-367.576}
        x2={305.457}
        y2={-357.862}
    ...
    <g>
      <path
        ...
        fill="url(#e3494492-9322-4864-b215-4b13d5db2a3c)"
      />
      <path
      ...
      <path
        ...
        fillRule="evenodd"
        fill="url(#f1488af2-2554-4dd5-a9ad-c1ce2894eaa1)"
      />
      <path
      ...
      />
      <path
        d="M12.451,13.6a.092.092,0,0,1,.008-.071l.287-.515a.093.093,0,0,1,.122-.039,1.018,1.018,0,0,0,.45.105,1.063,1.063,0,0,0,1.02-.82.092.092,0,0,1,.09-.071h.585a.093.093,0,0,1,.093.093.077.077,0,0,1,0,.015,1.83,1.83,0,0,1-1.786,1.561,1.75,1.75,0,0,1-.821-.2A.1.1,0,0,1,12.451,13.6ZM15,12.379a1.733,1.733,0,0,1-1.677,1.391,1.674,1.674,0,0,1-.778-.192l.287-.516a1.113,1.113,0,0,0,.491.114,1.155,1.155,0,0,0,1.11-.89h.585Q15.005,12.333,15,12.379Z"
        fill="#1453c8"
        fillRule="evenodd"
      />
      <path
        d="M11.3,10.967a1.891,1.891,0,0,0-.356-.359A1.927,1.927,0,0,0,9.9,10.215V9.648a2.533,2.533,0,0,1,1.157.35,2.478,2.478,0,0,1,.656.566Z"
        fill="#88aef1"
      />
      <path
        d="M11.289,11.059a.092.092,0,0,1-.066-.036,1.738,1.738,0,0,0-.339-.341,1.818,1.818,0,0,0-.989-.374.094.094,0,0,1-.086-.093V9.648A.093.093,0,0,1,9.9,9.555h.006a2.623,2.623,0,0,1,1.2.364,2.56,2.56,0,0,1,.681.587.091.091,0,0,1-.008.125l-.418.4a.094.094,0,0,1-.072.025Zm-.05-.165c.02.024.039.048.058.073l.418-.4A2.5,2.5,0,0,0,9.9,9.648v.567a1.911,1.911,0,0,1,1.337.679Z"
        fill="#88aef1"
        fillRule="evenodd"
      />
    </g>
...
const Memo = memo(SvgAzureDevopsStarter);
export default Memo;
