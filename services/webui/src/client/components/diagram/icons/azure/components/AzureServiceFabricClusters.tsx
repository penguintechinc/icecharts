...
const SvgAzureServiceFabricClusters = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      d="M16,7.2,10.24,3.09h0L9,2.18H9l-1.22.9h0L2,7.2H2L4.25,14h0l.47,1.44h8.6L13.77,14h0L16,7.25h0ZM5.76,14l-2-6.22L9,4l5.28,3.79-2,6.22Z"
      fill="#e27908"
    />
...
const Memo = memo(SvgAzureServiceFabricClusters);
export default Memo;
