...
const SvgAzureApplicationSecurityGroups = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      d="M16,8.44c0,4.57-5.53,8.25-6.73,9a.43.43,0,0,1-.46,0C7.57,16.69,2,13,2,8.44V2.94a.44.44,0,0,1,.43-.44C6.77,2.39,5.78.5,9,.5s2.23,1.89,6.53,2a.44.44,0,0,1,.43.44Z"
      fill="#1b93eb"
    />
    <path
      ...
      fill="url(#a3df7d19-3d54-4d86-b7b8-c8d5b9b1be6b)"
    />
    <path
      d="M10.94,12.72c-1.07-.14-1-.83-1-1.94h-2c0,1.11,0,1.8-1,1.94a.56.56,0,0,0-.51.49h5.1A.56.56,0,0,0,10.94,12.72Z"
      fill="#1f56a3"
    />
    ...
    <polygon
      points="8.89 7.51 8.88 7.52 8.88 9.42 8.88 9.42 10.53 8.46 8.89 7.51"
      fill="#5ea0ef"
      opacity={0.2}
    />
    <polygon
      points="8.87 7.54 8.88 7.54 8.88 9.44 8.88 9.44 7.23 8.49 8.87 7.54"
      fill="#83b9f9"
      opacity={0.2}
    />
  </svg>
);
const Memo = memo(SvgAzureApplicationSecurityGroups);
export default Memo;
