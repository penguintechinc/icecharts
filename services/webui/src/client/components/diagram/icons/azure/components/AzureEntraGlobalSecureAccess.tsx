...
const SvgAzureEntraGlobalSecureAccess = (props: SVGProps<SVGSVGElement>) => (
  <svg
    id="uuid-f52009a1-f592-4dee-ae49-35f96786cd51"
  ...
  >
    <defs>
      <linearGradient
        id="uuid-798f5406-4b1d-4b30-8961-96541b064b77"
        x1={0}
        y1={9}
        x2={12.076}
        y2={9}
      ...
      <linearGradient
        id="uuid-eb9e626c-c10c-4ce4-8c0b-fc6edc426ceb"
        x1={9}
        y1={18}
        x2={9}
        y2={0}
      ...
      <linearGradient
        id="uuid-6a5304a5-05a9-4c37-ba49-f088c182d3ce"
        x1={13.5}
        y1={18}
        x2={13.5}
        y2={0}
