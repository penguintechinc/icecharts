...
const SvgAzureVirtualMachine = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <rect
      ...
      height={12}
      rx={0.6}
      fill="url(#f34d9569-2bd0-4002-8f16-3d01d8106cb5)"
    />
    ...
    <path
      ...
      fill="url(#bdb45a0b-eb58-4970-a60a-fb2ce314f866)"
    />
  </svg>
);
const Memo = memo(SvgAzureVirtualMachine);
export default Memo;
