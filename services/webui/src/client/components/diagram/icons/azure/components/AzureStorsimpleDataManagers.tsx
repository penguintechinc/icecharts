...
const SvgAzureStorsimpleDataManagers = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <linearGradient
        ...
        x2={15.3}
        y2={10.17}
        gradientTransform="translate(0.1 -0.03) rotate(0.15)"
    ...
    <title>{'Icon-storage-92'}</title>
    <path
      d="M9,5.14c-3.52,0-6.37-1-6.37-2.33l0,12.35c0,1.27,2.8,2.31,6.28,2.34H9c3.52,0,6.38-1,6.38-2.31l0-12.35C15.39,4.12,12.53,5.15,9,5.14Z"
      fill="url(#b53f55b6-5b8c-4246-8553-f63a4c06f010)"
    />
    <path
