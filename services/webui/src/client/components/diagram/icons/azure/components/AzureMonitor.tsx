  ...
  >
    <defs>
      <radialGradient
        ...
        cy={7.45}
        r={8.42}
        gradientTransform="translate(3.23 1.51) scale(1.01 1.01)"
      ...
      <radialGradient
        ...
        cy={202.29}
        r={2.7}
        gradientTransform="translate(-17.77 -185.01) scale(0.95)"
        gradientUnits="userSpaceOnUse"
      >
    ...
    <ellipse cx={9} cy={9} rx={8.5} ry={8.47} fill="url(#ac8b32da-30ca-4b92-8d0f-8d2d5ef278a0)" />
    ...
    <path
      d="M4.87,4.27l2,2a3.41,3.41,0,0,1,1.71-.7V2.74A6.25,6.25,0,0,0,4.87,4.27Z"
      fill="#32bedd"
    />
    <path d="M11.78,6.85a3.6,3.6,0,0,1,.71,1.71h2.79a6.16,6.16,0,0,0-1.53-3.67Z" fill="#32bedd" />
    <path
      d="M6.22,6.85l-2-2A6.16,6.16,0,0,0,2.72,8.56H5.51A3.6,3.6,0,0,1,6.22,6.85Z"
      fill="#50e6ff"
    />
    <path
      d="M14.14,7a.45.45,0,0,0-.57-.25L9.45,8.41l.32.81,4.12-1.63A.44.44,0,0,0,14.14,7Z"
      fill="#f04049"
    />
    <ellipse cx={9} cy={9} rx={1.2} ry={1.2} fill="url(#a9954820-cb38-4943-9842-f0a568d2b015)" />
  </svg>
);
const Memo = memo(SvgAzureMonitor);
export default Memo;
