...
const SvgAzureIndustrialIot = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" {...props}>
    ...
    <path
      d="M8.093,7.994H5.513L5.9,4.22a.33.33,0,0,1,.329-.3H7.377a.331.331,0,0,1,.33.3Z"
      fill="#32bedd"
    />
    <path
      d="M10.373,8.161H8.534L8.809,5.6a.236.236,0,0,1,.235-.214h.819A.237.237,0,0,1,10.1,5.6Z"
      fill="#32bedd"
    />
    <path
      d="M13.586,7.434H4.415a.385.385,0,0,0-.385.385v4.2a.385.385,0,0,0,.385.384H9.673V10.854a.189.189,0,0,1,.189-.189h1.065a.189.189,0,0,1,.189.189V12.4h2.47a.384.384,0,0,0,.385-.384v-4.2A.385.385,0,0,0,13.586,7.434Z"
    ...
    <rect x={10.972} y={8.639} width={1.524} height={1.115} rx={0.138} fill="#fff" />
    {'\u200B\n'}
  </svg>
);
const Memo = memo(SvgAzureIndustrialIot);
export default Memo;
