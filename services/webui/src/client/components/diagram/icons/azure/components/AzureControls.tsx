...
const SvgAzureControls = (props: SVGProps<SVGSVGElement>) => (
    ...
    <g id="ab374360-11d9-4f16-97f5-dd9a2bb205a4">
      <g>
        ...
        <rect
          ...
          height={11.838}
          rx={0.596}
          fill="url(#e02af67e-3cdd-43d3-88a9-c6ddc82b95a9)"
        />
        <rect
          x={7.693}
          y={14.256}
          ...
          height={3.744}
          rx={0.596}
          fill="url(#a19a37d8-8580-4faa-8874-aa25009348ee)"
        />
        <rect
          x={13.197}
          y={6.162}
          ...
          height={11.838}
          rx={0.596}
          fill="url(#b34ba000-ac29-406f-900e-9de8ab1a03a8)"
        />
...
const Memo = memo(SvgAzureControls);
export default Memo;
