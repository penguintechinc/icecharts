...
const SvgAzureStorageAccountsClassic = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      ...
      fill="url(#bf742bd2-510c-4ed0-8c96-14df7349dd34)"
    />
    <path
...
const Memo = memo(SvgAzureStorageAccountsClassic);
export default Memo;
