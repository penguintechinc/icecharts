...
const SvgAzureAzureDatabaseMysqlServer = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      ...
      fill="url(#e291aba6-8038-4db1-a04d-c7be74f5a3e6)"
    />
    <path
    ...
    />
    <path
      d="M12.64,9v1.63h-1a.39.39,0,0,1-.29-.14V9H10v1.78a.92.92,0,0,0,1,.89h1.49l.26-.13s-.11.41-.26.43H10.11v1h2.66A1.21,1.21,0,0,0,14,11.7V9Z"
      fill="#f2f2f2"
    />
    <path
      d="M9.53,9s0,0,0,0V8.51a.7.7,0,0,0-.48-.77,1.74,1.74,0,0,0-.5-.08.94.94,0,0,0-.91.58l-.78,1.9-1-1.9A.93.93,0,0,0,5,7.66a1.44,1.44,0,0,0-.51.09c-.35.11-.43.34-.43.73v3.31H5.23V9.56l.63,1.57a1.08,1.08,0,0,0,1,.66c.44,0,.62-.26.8-.66l.67-1.51v2.15H9.51V9h0Z"
      fill="#f2f2f2"
    />
  </svg>
);
const Memo = memo(SvgAzureAzureDatabaseMysqlServer);
export default Memo;
