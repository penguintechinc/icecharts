...
const SvgAzureImageDefinitions = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g>
      <rect
        ...
        height={16.88}
        rx={0.56}
        fill="url(#abcca3e9-b94e-41fe-a92a-6f6cddbb1654)"
      />
      <path
        d="M17.58,12.38,14.71,9.51a.15.15,0,0,0-.25.1v1.68c-3.45,0-6.9,1.84-6.9,5.16.49-.74,3-2.71,6.9-2.71v1.61a.15.15,0,0,0,.25.1l2.87-2.87A.15.15,0,0,0,17.58,12.38Z"
        fill="#773adc"
      />
      <g>
...
const Memo = memo(SvgAzureImageDefinitions);
export default Memo;
