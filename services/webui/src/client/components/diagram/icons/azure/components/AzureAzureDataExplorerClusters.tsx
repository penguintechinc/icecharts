...
const SvgAzureAzureDataExplorerClusters = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g>
      ...
      <path
        ...
        d="M5.53,5.53l6.94,6.94,5-5V1.07A.57.57,0,0,0,16.93.5H10.56Z"
        fill="#50e6ff"
      />
      <rect
...
const Memo = memo(SvgAzureAzureDataExplorerClusters);
export default Memo;
