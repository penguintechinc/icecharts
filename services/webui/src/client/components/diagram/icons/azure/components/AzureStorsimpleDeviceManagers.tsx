...
const SvgAzureStorsimpleDeviceManagers = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      d="M18,9.5a4.06,4.06,0,0,0-3.51-3.89A5.1,5.1,0,0,0,9.24.74a5.23,5.23,0,0,0-5,3.41A4.82,4.82,0,0,0,0,8.79,4.9,4.9,0,0,0,5.07,13.5l.44,0h8.21a1.46,1.46,0,0,0,.22,0A4.1,4.1,0,0,0,18,9.5Z"
      fill="url(#b221527c-9a9d-4fa7-808a-53af4b8654b1)"
    />
...
const Memo = memo(SvgAzureStorsimpleDeviceManagers);
export default Memo;
