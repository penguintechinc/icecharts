...
const SvgAzureReservations = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <rect
      ...
      width={1.27}
      height={0.41}
      transform="translate(0.2 10.54) rotate(-45)"
      fill="#7a7a7a"
    />
    <rect
    ...
    <rect
      ...
      width={0.41}
      height={1.27}
      transform="translate(-5.5 12.85) rotate(-45)"
      fill="#7a7a7a"
    />
    <rect
    ...
    <rect
      ...
      width={0.41}
      height={1.27}
      transform="translate(-2.15 4.78) rotate(-45)"
      fill="#7a7a7a"
    />
    <rect
      ...
      width={1.27}
      height={0.41}
      transform="translate(-7.87 7.2) rotate(-45)"
      fill="#7a7a7a"
    />
    <rect
    ...
    />
    <path
      d="M8.84.58h0a.61.61,0,0,0-.61.62.63.63,0,0,0,.62.63h0A7.26,7.26,0,1,1,3.49,4.18L4,4.92,5.42,1.76,2,2.16l.75,1A8.49,8.49,0,1,0,8.84.58Z"
      fill="url(#e06ba36b-1ed2-427f-984a-8a1ccedfe1e8)"
    />
    ...
    <rect
      ...
      height={4.08}
      rx={0.52}
      transform="translate(25.29 10.91) rotate(135)"
      fill="#7a7a7a"
    />
    <circle cx={8.81} cy={9.08} r={1.2} fill="url(#fa165c1e-e8e6-4b24-b8c0-57e284d1b1dc)" />
  </svg>
);
const Memo = memo(SvgAzureReservations);
export default Memo;
