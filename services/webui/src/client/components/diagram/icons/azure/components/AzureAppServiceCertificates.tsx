...
const SvgAzureAppServiceCertificates = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <rect
      ...
      height={12.75}
      rx={0.6}
      fill="url(#efc95f57-28bf-41de-a09e-d4f8c25449a4)"
    />
    <rect x={1.05} y={1.88} width={15.9} height={10.5} rx={0.3} fill="#fff" />
    <path
      id="bcc3d4fb-2f67-48ef-b6e7-f3c11ba0061b"
      d="M14.94,9.34a.29.29,0,0,1-.28.29H8.16a.29.29,0,0,1,0-.58h6.5a.28.28,0,0,1,.28.29"
      fill="#d15900"
    />
    <path
      id="e696babd-447d-4e2b-bc61-f978fd3ed1bc"
      d="M14.94,7.54a.29.29,0,0,1-.28.29H8.16a.29.29,0,0,1,0-.58h6.5a.28.28,0,0,1,.28.29"
      fill="#d15900"
    />
    <path
      id="b5d2bd6a-dd0a-43be-bfa5-16266f75812c"
      d="M14.94,4.93a.28.28,0,0,1-.28.29H3.77a.29.29,0,1,1,0-.58H14.66a.28.28,0,0,1,.28.29"
      fill="#d15900"
    />
    <path
...
const Memo = memo(SvgAzureAppServiceCertificates);
export default Memo;
