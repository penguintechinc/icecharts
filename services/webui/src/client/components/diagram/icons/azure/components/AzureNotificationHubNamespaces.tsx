...
const SvgAzureNotificationHubNamespaces = (props: SVGProps<SVGSVGElement>) => (
  <svg
    id="b195302b-e778-4b96-bfb7-8807a5f658f3"
  ...
  >
    <defs>
      <linearGradient
        id="a9fe2d6c-5ab5-424a-b9f8-0c4881eb70fd"
        x1={9}
        y1={0.81}
        x2={9}
        y2={21.28}
    ...
    <g>
      <g>
        <path
          ...
          fill="url(#a9fe2d6c-5ab5-424a-b9f8-0c4881eb70fd)"
        />
        <path
...
const Memo = memo(SvgAzureNotificationHubNamespaces);
export default Memo;
