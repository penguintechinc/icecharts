...
const SvgAzureEntraIdentityLicenses = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" {...props}>
    ...
    <g id="b8825e32-a13e-4dfe-984b-acf88935f544">
      <g>
        <g>
          <path
            d="M14.29,16.9a1.358,1.358,0,0,0,1.364-1.354,1.488,1.488,0,0,0-.009-.164c-.534-4.272-2.972-7.751-7.622-7.751-4.731,0-7.172,2.946-7.647,7.762a1.366,1.366,0,0,0,1.219,1.5c.045,0,.091.007.137.007Z"
            fill="url(#a16adbb9-578e-482b-adfc-4d82cc09754e)"
          />
          <path
            d="M8.023,8.644A4.262,4.262,0,0,1,5.7,7.961l2.3,6L10.281,8A4.256,4.256,0,0,1,8.023,8.644Z"
            fill="#fff"
            opacity={0.8}
          />
          <circle
...
const Memo = memo(SvgAzureEntraIdentityLicenses);
export default Memo;
