...
const SvgAzureAzureFileshares = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" {...props}>
    ...
    <g id="bce83c25-9afe-4c01-b0b0-4312ccacb0c8">
      <g>
        ...
        <g>
          <path
            d="M15.17,4.75l-6.91-1H8.12a1,1,0,0,0-1,.87L6.86,6.31H16L16,5.9A1,1,0,0,0,15.17,4.75Z"
            fill="#0078d4"
          />
          <path
            d="M15.1,5.18l-6.9-1H8.11a.58.58,0,0,0-.57.5L7.3,6.31h8.22l.07-.47A.58.58,0,0,0,15.1,5.18Z"
            fill="#fff"
          />
        </g>
        <path
          d="M5.26,5h6.05a.33.33,0,0,1,.21.09l1,1a.29.29,0,0,0,.21.09h4.6a.3.3,0,0,1,.3.29V13.9a.3.3,0,0,1-.3.29h-12A.29.29,0,0,1,5,13.9V5.32A.3.3,0,0,1,5.26,5Z"
...
const Memo = memo(SvgAzureAzureFileshares);
export default Memo;
