...
const SvgAzureCommit = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" {...props}>
    ...
    <g id="a31aa9c1-08d3-4ffe-a43f-26cfae7c34c3">
      <g>
        <path
          d="M5.1,4.213,8.7.612a.43.43,0,0,1,.608,0l3.6,3.6a.192.192,0,0,1-.135.328H10.555a.191.191,0,0,0-.192.191v4.5a.154.154,0,0,1-.153.153H7.79a.154.154,0,0,1-.153-.153v-4.5a.191.191,0,0,0-.192-.191H5.23A.192.192,0,0,1,5.1,4.213Z"
          fill="url(#eaab862f-d5c6-4926-83e4-0adf73ca7db0)"
        />
        <rect
          y={11.713}
          width={18}
          height={5.801}
          rx={0.581}
          fill="url(#afc223ac-f563-4c00-a62e-e2bc9c53b148)"
        />
...
const Memo = memo(SvgAzureCommit);
export default Memo;
