...
const SvgAzureDeviceConfiguration = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <rect x={5.79} y={16.16} width={1.14} height={0.97} rx={0.27} fill="#f2f2f2" />
    <rect x={5.19} y={1.07} width={2.34} height={0.31} rx={0.14} fill="#f2f2f2" />
    <rect
      x={2.23}
      y={1.94}
      width={8.26}
    ...
    <circle
      ...
      cy={13.04}
      r={1.4}
      transform="translate(-4.45 19.39) rotate(-67.17)"
      fill="#fff"
    />
  </svg>
);
const Memo = memo(SvgAzureDeviceConfiguration);
export default Memo;
