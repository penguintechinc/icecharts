...
const SvgAzureWebsiteStaging = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" {...props}>
    ...
    <g id="e1d66782-0311-4f04-9e41-92ce22baac72">
      <g>
        <path
          d="M17.166,7.95a3.669,3.669,0,0,0-3.185-3.527A4.624,4.624,0,0,0,9.218,0,4.745,4.745,0,0,0,4.683,3.092,4.379,4.379,0,0,0,.834,7.305a4.444,4.444,0,0,0,4.6,4.271c.136,0,.271-.007.405-.018h7.447a.749.749,0,0,0,.2-.029A3.713,3.713,0,0,0,17.166,7.95Z"
          fill="url(#f1d663a9-64c8-43fb-a40f-a24a6c8f7510)"
        />
...
const Memo = memo(SvgAzureWebsiteStaging);
export default Memo;
