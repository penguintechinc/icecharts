...
const SvgAzureResourceGroupList = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        ...
        x2={-6428.21}
        y2={9617.899}
        gradientTransform="matrix(0.5, 0, 0, -0.5, 3224.856, 4823.856)"
    ...
    <g id="a05a9809-540f-4ec8-9a73-07896b5e7f5c">
      <g>
        ...
        <rect
          ...
          height={1.243}
          rx={0.581}
          transform="translate(-10.133 6.282) rotate(-45)"
          fill="#198ab3"
        />
...
const Memo = memo(SvgAzureResourceGroupList);
export default Memo;
