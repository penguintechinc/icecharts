...
const SvgAzureStorageExplorer = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" {...props}>
    ...
    <g id="eba65084-93f2-4c1d-af99-2c8b228075b7">
      <g>
        <path
          d="M16.218,6.589H11.293a.259.259,0,0,0-.259.259V9.829a.259.259,0,0,1-.259.259H6.406a.257.257,0,0,0-.257.257v3.043a.26.26,0,0,1-.26.259H1.521a.258.258,0,0,0-.258.257v3.581A.516.516,0,0,0,1.778,18h9.816a.233.233,0,0,0,.053-.006h4.571a.518.518,0,0,0,.519-.518V7.107A.518.518,0,0,0,16.218,6.589Z"
...
const Memo = memo(SvgAzureStorageExplorer);
export default Memo;
