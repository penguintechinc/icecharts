...
const SvgAzureAzureWorkbooks = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" {...props}>
    ...
    <g id="b29c674a-46cd-4195-96d0-b29284b870b6">
      <g>
        <path
          d="M7.773,3.682,0,11.455v4.909A1.637,1.637,0,0,0,1.636,18H16.364A1.637,1.637,0,0,0,18,16.364V1.636A1.637,1.637,0,0,0,16.364,0h-.819L9.818,5.727Z"
          fill="url(#abe241b1-5a9a-45d6-aa6a-018218fcb790)"
        />
        <path
          d="M7.773,8.591.586,15.778a1.194,1.194,0,0,0-.381,1.379A1.635,1.635,0,0,0,1.636,18H16.364A1.637,1.637,0,0,0,18,16.364V2.455L9.818,10.636Z"
          fill="url(#aa8b03fb-bed7-4004-829e-edcb663a744f)"
        />
        <path
          d="M9.818,5.727,15.545,0H1.636A1.637,1.637,0,0,0,0,1.636v9.819L7.773,3.682Z"
...
const Memo = memo(SvgAzureAzureWorkbooks);
export default Memo;
