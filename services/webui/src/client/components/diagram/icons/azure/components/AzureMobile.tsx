...
const SvgAzureMobile = (props: SVGProps<SVGSVGElement>) => (
    ...
    <g id="abf8a417-4093-4c62-8738-0493c164e5d3">
      <g>
        <rect
          ...
          height={18}
          rx={0.419}
          fill="url(#b861ecb1-69d3-40ff-b38a-443a49a377b1)"
        />
        ...
        <rect
          ...
          rx={0.201}
          opacity={0.9}
          fill="url(#b829f877-fb68-49d0-8cb6-c12a07b10184)"
        />
        <rect x={8.398} y={16.58} width={1.204} height={1.028} rx={0.286} fill="#f2f2f2" />
        <polygon
          points="11.882 7.378 11.882 10.624 9.077 12.255 9.077 9.004 11.882 7.378"
          fill="#005ba1"
        />
        <polygon
          points="11.882 7.378 9.078 9.009 6.272 7.378 9.078 5.747 11.882 7.378"
          fill="#5ea0ef"
        />
        <polygon
          points="9.077 9.009 9.077 12.255 6.272 10.624 6.272 7.378 9.077 9.009"
          fill="#0078d4"
        />
      </g>
    </g>
...
const Memo = memo(SvgAzureMobile);
export default Memo;
