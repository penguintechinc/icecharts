...
const SvgAzureSearch = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" {...props}>
    <defs>
      <radialGradient
        id="ea8ddd8a-48ba-441c-8311-10e5bddbfbfb"
        cx={10.629}
        cy={7.175}
        r={6.675}
    ...
    <g id="e958cf41-a31a-426c-90ab-58b20591ece8">
      <g>
        ...
        <circle
          ...
          cy={7.175}
          r={6.675}
          fill="url(#ea8ddd8a-48ba-441c-8311-10e5bddbfbfb)"
        />
...
const Memo = memo(SvgAzureSearch);
export default Memo;
