...
const SvgAzureAppRegistrations = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      d="M5.67,10.61H10v4.32H5.67Zm-5-5.76H5V.53H1.23a.6.6,0,0,0-.6.6Zm.6,10.08H5V10.61H.63v3.72A.6.6,0,0,0,1.23,14.93Zm-.6-5H5V5.57H.63Zm10.08,5h3.72a.6.6,0,0,0,.6-.6V10.61H10.71Zm-5-5H10V5.57H5.67Zm5,0H15V5.57H10.71Zm0-9.36V4.85H15V1.13a.6.6,0,0,0-.6-.6Zm-5,4.32H10V.53H5.67Z"
      fill="url(#efeb8e96-2af0-4681-9a6a-45f9b0262f19)"
    />
...
const Memo = memo(SvgAzureAppRegistrations);
export default Memo;
