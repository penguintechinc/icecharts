...
const SvgAzureBuilds = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        ...
        x2={-4199.359}
        y2={982.921}
        gradientTransform="translate(-4190.224 990.809) rotate(180)"
    ...
    <g id="efce58b1-e297-4fa7-8d29-7ddbd73756de">
      <g>
        <path
          d="M12.362,4.809,9.386,7.785a.356.356,0,0,1-.5,0L5.909,4.809a.159.159,0,0,1,.112-.271h1.83a.158.158,0,0,0,.158-.158V.661A.127.127,0,0,1,8.136.534h2a.126.126,0,0,1,.126.127V4.38a.159.159,0,0,0,.159.158h1.83A.159.159,0,0,1,12.362,4.809Z"
          fill="url(#b0b56ca2-72b1-41c5-af06-32eb990813e7)"
        />
        <rect
          x={0.5}
          y={12.672}
          ...
          height={4.793}
          rx={0.513}
          fill="url(#a6beae7e-dfa6-485f-bc06-215b34038868)"
        />
        <g>
...
const Memo = memo(SvgAzureBuilds);
export default Memo;
