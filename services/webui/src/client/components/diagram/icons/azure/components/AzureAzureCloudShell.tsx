...
const SvgAzureAzureCloudShell = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" {...props}>
    ...
    <g fill="#fff">
      <rect x={4.576} y={10.738} width={2.837} height={0.527} rx={0.263} />
...
const Memo = memo(SvgAzureAzureCloudShell);
export default Memo;
