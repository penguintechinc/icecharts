...
const SvgAzureTimeSeriesInsightsEnvironments = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g id="a96c4dc0-0b65-4066-a8fa-5efc74b0b38e">
      <path
        ...
        fill="url(#a318d17a-947d-498f-80c1-0e0bae8f5723)"
      />
      <path
        d="M9.64,13.141,7.5,8.33,6.6,9.885H1.093a.811.811,0,0,1,0-1.622H5.666l2.025-3.5,2.332,5.246L11.4,8.246l5.51.012a.811.811,0,0,1,0,1.622h0l-4.716-.011Z"
        fill="#50e6ff"
      />
    </g>
  </svg>
);
const Memo = memo(SvgAzureTimeSeriesInsightsEnvironments);
export default Memo;
