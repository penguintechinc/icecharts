...
const SvgAzureNetworkWatcher = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <radialGradient
        ...
        cy={45.13}
        r={6.4}
        gradientTransform="translate(5.04 -35.89) scale(0.94)"
