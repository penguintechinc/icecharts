...
const SvgAzureNetworkSecurityGroups = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <path
      d="M9,9V.75c3.13,0,2.17,1.83,6.34,1.94a.43.43,0,0,1,.41.43V8.46a4.89,4.89,0,0,1,0,.54ZM9,9H2.28c.4,4.18,5.38,7.5,6.5,8.19a.39.39,0,0,0,.18.06H9Z"
      fill="url(#fe5ce43f-2823-4617-bb54-57df9e778372)"
    />
    <path
      d="M2.66,2.69C6.83,2.58,5.87.75,9,.75V9H2.28a4.89,4.89,0,0,1,0-.54V3.12A.43.43,0,0,1,2.66,2.69Z"
      fill="#50e6ff"
    />
    <path
      d="M15.72,9H9v8.25H9a.39.39,0,0,0,.18-.06C10.34,16.5,15.32,13.18,15.72,9Z"
      fill="#50e6ff"
    />
  </svg>
);
const Memo = memo(SvgAzureNetworkSecurityGroups);
export default Memo;
