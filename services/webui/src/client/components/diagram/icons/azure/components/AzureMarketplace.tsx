...
const SvgAzureMarketplace = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path id="f354248b-347f-4f34-a8b1-60412d94c898" d="M15,4.77h-1v12.8l1-1.93Z" fill="#50e6ff" />
    <path
    ...
    <path
      ...
      fill="#767676"
    />
    <polygon points="13.92 4.77 13.92 17.57 1.45 16.58 1.83 4.77 13.92 4.77" fill="#32bedd" />
    <polygon points="14.95 4.77 14.95 15.64 16.18 15.82 15.81 4.77 14.95 4.77" fill="#32bedd" />
    <path
...
const Memo = memo(SvgAzureMarketplace);
export default Memo;
