...
const SvgAzureVmScaleSets = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <rect
      ...
      height={6.75}
      rx={0.34}
      fill="url(#b816c8ea-05a2-41fb-ba99-96d84599c9f4)"
    />
    ...
    <path
      d="M14.76,17.32c-1-.16-1-.88-1-2h-2c0,1.16,0,1.88-1,2a.59.59,0,0,0-.5.57h5A.59.59,0,0,0,14.76,17.32Z"
      fill="url(#ab373d88-41af-4fc3-b172-d4489f9107a0)"
    />
  </svg>
);
const Memo = memo(SvgAzureVmScaleSets);
export default Memo;
