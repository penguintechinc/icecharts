...
const SvgAzureAutomationAccounts = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      ...
      <linearGradient
        ...
        x2={-26.189}
        y2={-311.105}
        gradientTransform="translate(39.425 321.61) scale(1.156 1.029)"
        gradientUnits="userSpaceOnUse"
      >
    ...
    <title>{'Icon-322Artboard 1'}</title>
    <path
      ...
      fill="url(#ec4358fa-c977-42e2-a7ab-994b5de56830)"
    />
    <path
      d="M8.5,10.5H4.9a.215.215,0,0,1-.2-.2v-.1L9,1.7c0-.1.1-.1.2-.1h4.2a.215.215,0,0,1,.2.2v.1L8.5,8.6h4.9a.215.215,0,0,1,.2.2.1.1,0,0,1-.1.1L5.3,17.4c-.1,0-.6.5-.4-.2h0Z"
      fill="url(#aae9e42c-091e-4dc7-8bec-a93418af93c4)"
    />
  </svg>
);
const Memo = memo(SvgAzureAutomationAccounts);
export default Memo;
