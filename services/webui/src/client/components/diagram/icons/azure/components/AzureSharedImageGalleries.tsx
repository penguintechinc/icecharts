...
const SvgAzureSharedImageGalleries = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g>
      ...
      <rect
        ...
        height={5.99}
        rx={0.56}
        fill="url(#bc25fd79-1e91-4c2f-8691-1f9665f6d0dc)"
      />
      <rect x={6.6} y={12.92} width={4.81} height={0.87} rx={0.43} fill="#f2f2f2" />
    </g>
  </svg>
);
const Memo = memo(SvgAzureSharedImageGalleries);
export default Memo;
