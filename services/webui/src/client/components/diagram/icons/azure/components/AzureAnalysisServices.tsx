...
const SvgAzureAnalysisServices = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <path
      d="M13.15,8.92l.23-.64L4.82,5.13l-.23.63Zm.53-.09-.32-.6L5.29,12.48l.31.6ZM5,13.37l.67-.12L4.31,5.54l-.67.12Z"
      fill="#773adc"
    />
    <circle
      cx={14.04}
      cy={8.23}
      r={1.08}
      transform="translate(-2.23 8.81) rotate(-32.41)"
      fill="#fff"
    />
    <circle
      cx={3.96}
      cy={5.17}
      r={1.08}
      transform="translate(-2.15 2.93) rotate(-32.41)"
      fill="#fff"
    />
    <circle
      cx={5.29}
      cy={12.83}
      r={1.08}
      transform="translate(-6.05 4.83) rotate(-32.41)"
      fill="#fff"
    />
  </svg>
);
const Memo = memo(SvgAzureAnalysisServices);
export default Memo;
