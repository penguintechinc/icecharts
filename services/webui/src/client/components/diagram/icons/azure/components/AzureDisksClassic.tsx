...
const SvgAzureDisksClassic = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      ...
      <linearGradient
        ...
        x2={12.94}
        y2={810.58}
        gradientTransform="translate(0 -1278.76) scale(1 1.59)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset={0} stopColor="#0078d4" />
    ...
    <title>{'Icon-compute-32'}</title>
    <ellipse cx={8.96} cy={11.82} rx={7.5} ry={3.08} fill="#76bc2d" />
    <ellipse cx={9.15} cy={11.79} rx={2.49} ry={0.68} fill="#5e9624" />
    <path d="M15.35,13.4l0,0Z" fill="url(#a3aecb5c-11f5-4ece-99f7-9672f3236156)" />
    <ellipse
      cx={8.96}
      cy={4.99}
      rx={7.5}
      ry={3.08}
      fill="url(#b4dfb3ab-25fe-416c-a6fa-f33fcfbf22dc)"
    />
    <ellipse cx={9.15} cy={4.95} rx={2.49} ry={0.68} fill="#005ba1" />
    <path
      d="M9,14.84c4.15,0,7.5-1.38,7.5-3.08h0v1.82h0c-.14,1.65-3.44,3-7.5,3s-7.5-1.38-7.5-3.08V11.76C1.46,13.46,4.82,14.84,9,14.84Z"
      fill="#5e9624"
    />
    <path d="M15.35,13.4l0,0Z" fill="url(#a3aecb5c-11f5-4ece-99f7-9672f3236156)" />
    <path
      d="M9,8c4.15,0,7.5-1.38,7.5-3.08h0V6.74h0c-.14,1.65-3.44,3-7.5,3s-7.5-1.38-7.5-3.08V4.92C1.46,6.62,4.82,8,9,8Z"
      fill="#0078d4"
    />
  </svg>
);
const Memo = memo(SvgAzureDisksClassic);
export default Memo;
