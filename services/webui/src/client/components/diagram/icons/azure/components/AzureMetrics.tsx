...
const SvgAzureMetrics = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <ellipse
      ...
      rx={1.64}
      ry={1.65}
      fill="url(#e1d73f47-752a-4159-9841-f0e298db8522)"
    />
    <ellipse
      cx={11.02}
      cy={9.5}
      rx={1.64}
      ry={1.65}
      fill="url(#e8c6440a-2701-4507-8d04-c5dedd18bcf2)"
    />
    <ellipse
      cx={15.15}
      cy={2.15}
      rx={1.64}
      ry={1.65}
      fill="url(#b40385c6-522c-4b7d-afa0-c8216f314bdf)"
    />
    <ellipse
      cx={2.85}
      cy={10.22}
      rx={1.64}
      ry={1.65}
      fill="url(#a5c9d1e7-33fb-4353-b4bd-5d3732a54634)"
    />
...
const Memo = memo(SvgAzureMetrics);
export default Memo;
