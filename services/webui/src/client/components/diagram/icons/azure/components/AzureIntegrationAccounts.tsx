...
const SvgAzureIntegrationAccounts = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      ...
      d="M1.06,1.6V16.52a.54.54,0,0,0,.54.54H16.52a.54.54,0,0,0,.54-.54V1.6a.54.54,0,0,0-.54-.54H1.6A.54.54,0,0,0,1.06,1.6Zm14.56,14H3a.54.54,0,0,1-.54-.54V2.5H15.62Z"
      fill="#0078d4"
    />
    ...
    <path
      ...
      d="M3.62,11.62H6.5V14.5H3.62Z"
      fill="url(#b6d2ab89-b9ea-48bf-8e7f-c0a0e94aaccb)"
    />
    <path
      id="b42c6875-f245-4ba4-9264-2088283c3036"
      d="M7.62,11.62H10.5V14.5H7.62Z"
      fill="#e62323"
    />
    <path
      id="a8d52762-2bc4-48b4-9685-903c7c3b7d84"
      d="M11.62,11.62H14.5V14.5H11.62Z"
      fill="url(#aa835ab6-90f2-4950-9adc-1bef25952f94)"
    />
  </svg>
);
const Memo = memo(SvgAzureIntegrationAccounts);
export default Memo;
