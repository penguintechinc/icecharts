...
const SvgAzureSecurityBaselines = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <path
      d="M6.29,8.65H17.07a.35.35,0,0,1,.37.33v8.19a.35.35,0,0,1-.37.33H6.29a.36.36,0,0,1-.37-.33V9A.36.36,0,0,1,6.29,8.65Z"
      fill="#9cebff"
    />
    <path
      d="M6.27,8.65H17.09a.33.33,0,0,1,.35.31h0V10.2H5.92V9a.33.33,0,0,1,.35-.31Z"
      fill="#0078d4"
    />
    <path
      d="M15.87,13.41H8.76c-.16,0-.28.08-.28.16V14c0,.09.12.16.28.16h7.11c.16,0,.29-.07.29-.16v-.4C16.16,13.49,16,13.41,15.87,13.41Z"
      fill="#0078d4"
    />
    <path
      d="M15.87,11.61H8.76c-.16,0-.28.07-.28.16v.39c0,.09.12.16.28.16h7.11c.16,0,.29-.07.29-.16v-.39C16.16,11.68,16,11.61,15.87,11.61Z"
      fill="#0078d4"
    />
    <path
      d="M15.87,15.44H8.76c-.16,0-.28.07-.28.16V16c0,.09.12.16.28.16h7.11c.16,0,.29-.07.29-.16v-.4C16.16,15.51,16,15.44,15.87,15.44Z"
      fill="#0078d4"
    />
...
const Memo = memo(SvgAzureSecurityBaselines);
export default Memo;
