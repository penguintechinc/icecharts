...
const SvgAzureAvailabilitySets = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g>
      ...
      <polygon
        points="16.63 1.07 16.95 1.07 16.95 1.38 17.5 1.38 17.5 0.5 16.63 0.5 16.63 1.07"
        fill="#0078d4"
      />
      <polygon
        points="1.41 16.89 1.13 16.89 1.13 16.57 0.5 16.57 0.5 17.5 1.41 17.5 1.41 16.89"
        fill="#0078d4"
      />
      <polygon
        points="16.95 16.6 16.95 16.89 16.63 16.89 16.63 17.5 17.5 17.5 17.5 16.6 16.95 16.6"
        fill="#0078d4"
      />
      <polygon
        points="1.13 1.36 1.13 1.07 1.41 1.07 1.41 0.5 0.5 0.5 0.5 1.36 1.13 1.36"
        fill="#0078d4"
      />
      ...
      <g>
        <rect
          ...
          height={5.88}
          rx={0.29}
          fill="url(#b020d1a3-604d-4f79-8087-b021d39314c5)"
        />
        <g>
          <polygon
            points="11.77 8.91 11.77 10.62 10.31 11.48 10.31 9.77 11.77 8.91"
            fill="#50e6ff"
          />
        ...
        <path
          d="M12.07,14.48c-.87-.14-.9-.77-.9-1.78H9.44c0,1,0,1.64-.9,1.78a.51.51,0,0,0-.43.49h4.4A.51.51,0,0,0,12.07,14.48Z"
          fill="url(#fd885ea0-9b31-4878-9e85-930d64f33955)"
        />
      </g>
...
const Memo = memo(SvgAzureAvailabilitySets);
export default Memo;
