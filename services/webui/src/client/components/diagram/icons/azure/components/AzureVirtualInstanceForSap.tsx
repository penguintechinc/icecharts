...
const SvgAzureVirtualInstanceForSap = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="fc9e0ce2-d7de-4412-bda8-f01e2cc4e66a"
        x1={9}
        y1={12.48}
        x2={9}
        y2={1.147}
      ...
      <linearGradient
        id="e9e87259-0875-41e6-886b-2024b496a772"
        x1={9}
        y1={684.663}
        x2={9}
        y2={689.036}
      ...
      <linearGradient
        id="bf7ae98c-3eed-4cf6-9bb1-28dc4026a25b"
        x1={0.003}
        y1={-27.428}
        x2={0.003}
        y2={-28.757}
...
const Memo = memo(SvgAzureVirtualInstanceForSap);
export default Memo;
