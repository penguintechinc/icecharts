...
const SvgAzureRecent = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <radialGradient
        ...
        cy={17.42}
        r={9}
        gradientTransform="translate(16.02 -7.37) scale(0.94)"
      ...
      <radialGradient
        ...
        cy={18.5}
        r={1.26}
        gradientTransform="translate(15.68 -8.34) scale(0.94)"
        gradientUnits="userSpaceOnUse"
      >
    ...
    <title>{'Icon-general-6'}</title>
    <circle cx={8.88} cy={9.09} r={8.5} fill="url(#effe6513-9d59-4ea4-be18-9228e5407456)" />
    ...
    <rect
      ...
      width={1.27}
      height={0.41}
      transform="translate(0.22 10.63) rotate(-45)"
      fill="#7a7a7a"
    />
    <rect
    ...
    <rect
      ...
      width={0.41}
      height={1.27}
      transform="translate(-5.46 12.94) rotate(-45)"
      fill="#7a7a7a"
    />
    <rect
    ...
    <rect
      ...
      width={0.41}
      height={1.27}
      transform="translate(-2.12 4.89) rotate(-45)"
      fill="#7a7a7a"
    />
    <rect
      ...
      width={1.27}
      height={0.41}
      transform="translate(-7.82 7.3) rotate(-45)"
      fill="#7a7a7a"
    />
    <rect
      ...
      fill="#7a7a7a"
    />
    <rect x={8.4} y={2.83} width={1.14} height={6.52} rx={0.52} fill="#7a7a7a" />
    <rect
      x={9.92}
      y={8.65}
      width={1.14}
      height={4.08}
      rx={0.52}
      transform="translate(25.47 10.82) rotate(135)"
      fill="#7a7a7a"
    />
    <circle cx={8.92} cy={9.08} r={1.2} fill="url(#e025ef80-86ff-4bd1-bbc9-eb35b96a5a7e)" />
  </svg>
);
const Memo = memo(SvgAzureRecent);
export default Memo;
