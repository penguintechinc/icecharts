...
const SvgAzureDeviceCompliance = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      d="M10.9,13.22h.61a.19.19,0,0,1,.19.19v2.44a.19.19,0,0,1-.19.19h-.43a.19.19,0,0,1-.19-.19V13.22a0,0,0,0,1,0,0Z"
      transform="translate(29.63 16.98) rotate(135)"
      fill="#fff"
    />
    <path
      d="M13.61,10.66h.61a0,0,0,0,1,0,0v5.6a.19.19,0,0,1-.19.19h-.43a.19.19,0,0,1-.19-.19V10.85a.19.19,0,0,1,.19-.19Z"
      transform="translate(14 32.92) rotate(-135)"
      fill="#fff"
    />
  </svg>
);
const Memo = memo(SvgAzureDeviceCompliance);
export default Memo;
