...
const SvgAzureRouteFilters = (props: SVGProps<SVGSVGElement>) => (
  <svg
    id="a7fced15-da9f-41e0-8b9e-21a862586c87"
  ...
  >
    <defs>
      <linearGradient
        id="ace104d6-1f53-40e3-a991-cb43c1f1aa51"
        x1={5.82}
        y1={25.68}
        x2={5.82}
        y2={14.64}
        gradientTransform="translate(0 -11.41) scale(1 1.01)"
    ...
    <rect
      ...
      height={11.18}
      rx={0.58}
      fill="url(#ace104d6-1f53-40e3-a991-cb43c1f1aa51)"
    />
    <g>
...
const Memo = memo(SvgAzureRouteFilters);
export default Memo;
