...
const SvgAzureTranslatorText = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="bcf06cd3-a4b8-4fd5-87ad-fd0a708c782b"
        x1={9}
        x2={9}
        y2={18}
      ...
      <linearGradient
        id="ab8b109c-2878-45da-89b4-5b7b4d0302fd"
        x1={-998.057}
        y1={-213.109}
        x2={-1002.698}
        y2={-204.987}
        gradientTransform="translate(-195.271 1006.992) rotate(90)"
        gradientUnits="userSpaceOnUse"
      >
      ...
      <linearGradient
        id="aa22a732-ecb4-41ce-bd4f-17b24d84fd2f"
        x1={-122.365}
        y1={1106.487}
        x2={-127.006}
        y2={1114.61}
        gradientTransform="translate(-1106.024 -112.477) rotate(-90)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset={0} stopColor="#fff" />
        <stop offset={1} stopColor="#fff" stopOpacity={0.3} />
    ...
    <path
      d="M13.281,9.822a3.549,3.549,0,0,0-1.946.537v.94a2.819,2.819,0,0,1,1.868-.7q1.181,0,1.18,1.459l-1.717.241q-1.89.262-1.89,1.868a1.568,1.568,0,0,0,.484,1.2,1.882,1.882,0,0,0,1.339.453,1.921,1.921,0,0,0,1.762-1.029h.022v.895H15.3V11.958Q15.3,9.822,13.281,9.822Zm1.1,3.534a1.706,1.706,0,0,1-.445,1.211,1.47,1.47,0,0,1-1.126.478,1.155,1.155,0,0,1-.8-.265.874.874,0,0,1-.3-.685.913.913,0,0,1,.324-.8A2.247,2.247,0,0,1,13,12.976l1.381-.19Z"
      fill="#fff"
    />
    <path
      d="M13.782,8.891l1.537-1.58c.167-.166.106-.311-.16-.311h-.683a.2.2,0,0,1-.2-.2c.022-1.019-.264-3.848-4.129-3.944a.2.2,0,0,0-.2.2v1a.2.2,0,0,0,.216.2A2.373,2.373,0,0,1,13.026,6.8a.2.2,0,0,1-.2.2H12.2c-.322,0-.376.1-.161.311l1.425,1.58A.2.2,0,0,0,13.782,8.891Z"
      fill="url(#ab8b109c-2878-45da-89b4-5b7b4d0302fd)"
    />
    <path
      d="M4.52,9.932l-1.538,1.58c-.167.167-.106.311.161.311h.682a.2.2,0,0,1,.2.2C4,13.042,4.285,15.871,8.15,15.967a.2.2,0,0,0,.2-.2v-1a.2.2,0,0,0-.215-.2,2.373,2.373,0,0,1-2.863-2.551.2.2,0,0,1,.2-.2h.632c.321,0,.375-.1.16-.311L4.841,9.932A.2.2,0,0,0,4.52,9.932Z"
      fill="url(#aa22a732-ecb4-41ce-bd4f-17b24d84fd2f)"
    />
    <path
...
const Memo = memo(SvgAzureTranslatorText);
export default Memo;
