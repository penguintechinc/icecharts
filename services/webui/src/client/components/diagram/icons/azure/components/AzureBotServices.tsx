...
const SvgAzureBotServices = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <radialGradient
        ...
        cy={71.92}
        r={9}
        gradientTransform="translate(-43.61 -58.92) scale(0.94 0.94)"
    ...
    <path
      ...
      d="M9,.5A8.5,8.5,0,1,0,17.5,9,8.5,8.5,0,0,0,9,.5Z"
      fill="url(#b915730c-dc69-4cd4-8cf3-619882b8e8ab)"
    />
    <circle cx={9} cy={9} r={7.03} fill="#fff" />
    <circle cx={7.45} cy={9} r={0.77} fill="#32bedd" />
    <path
      d="M5.26,6.8H4.88a.29.29,0,0,0-.29.29v5.72a.59.59,0,0,0,.59.59h5.57a.29.29,0,0,0,.29-.3v-.38a.29.29,0,0,0-.29-.29h-5a.14.14,0,0,1-.14-.15V7.09A.29.29,0,0,0,5.26,6.8Z"
      fill="#32bedd"
    />
...
const Memo = memo(SvgAzureBotServices);
export default Memo;
