...
const SvgAzureHostGroups = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g>
      <path
        d="M14,.55H2a.68.68,0,0,0-.69.68V4.31A.69.69,0,0,0,2,5H14a.69.69,0,0,0,.69-.69V1.23A.69.69,0,0,0,14,.55Zm0,6.16H2a.68.68,0,0,0-.69.68v3.08a.69.69,0,0,0,.69.69H14a.69.69,0,0,0,.69-.69V7.39A.68.68,0,0,0,14,6.71Z"
        fill="#198ab3"
      />
      <path d="M9.15,5h1V15.26h-1Z" fill="#32bedd" />
      <path
        d="M16.13,1.92H3.92a.57.57,0,0,0-.57.57v3A.57.57,0,0,0,3.92,6H16.13a.57.57,0,0,0,.57-.57v-3A.57.57,0,0,0,16.13,1.92Z"
      ...
      <path
        d="M16.13,8.08H3.92a.57.57,0,0,0-.57.57v3a.57.57,0,0,0,.57.57H16.13a.57.57,0,0,0,.57-.57v-3A.57.57,0,0,0,16.13,8.08Z"
...
const Memo = memo(SvgAzureHostGroups);
export default Memo;
