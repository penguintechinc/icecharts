...
const SvgAzureSpatialAnchorAccounts = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g>
      ...
      />
      <path
        d="M14.08,8.56A2.36,2.36,0,0,0,12.67,9L8.22,5.87,1.08,10.94l7.14,5.42,4.53-3.44a2.42,2.42,0,0,0,1.33.4,2.38,2.38,0,1,0,0-4.76Zm-1.61.63h0ZM8.22,15.06,2.83,11,8.22,7.14,12,9.82h0a2.32,2.32,0,0,0-.28,1.12A2.4,2.4,0,0,0,12,12.16h0Zm4.07-5.69v0Zm-.16.21v0Zm.21,3,0,0Zm-.16-.19h0Zm.35.37,0,0Zm1.55-.45a1.35,1.35,0,1,1,0-2.69,1.35,1.35,0,0,1,0,2.69Z"
        fill="#50e6ff"
      />
      <circle
      ...
      />
      <path
        d="M14.08.5A3.35,3.35,0,0,0,10.83,4c0,1.53,1.94,5.11,2.82,7.25a.46.46,0,0,0,.85,0c.89-2.16,2.83-5.77,2.83-7.25A3.4,3.4,0,0,0,14.08.5Zm0,4.74A1.45,1.45,0,1,1,15.52,3.8,1.44,1.44,0,0,1,14.08,5.24Z"
        fill="url(#fa9d132d-3569-42e2-ae7f-64ec04cf2c7e)"
      />
    </g>
  </svg>
);
const Memo = memo(SvgAzureSpatialAnchorAccounts);
export default Memo;
