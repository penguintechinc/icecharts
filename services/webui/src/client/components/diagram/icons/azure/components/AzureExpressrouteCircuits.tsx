...
const SvgAzureExpressrouteCircuits = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <linearGradient
        ...
        x2={8.74}
        y2={6.22}
        gradientTransform="translate(2.03 -1.37) rotate(-0.08)"
    ...
    <rect
      ...
      width={1.98}
      height={9.5}
      transform="translate(5.25 -1.66) rotate(30)"
      fill="#a67af4"
    />
    <rect
      x={11.21}
      ...
      width={1.98}
      height={9.5}
      transform="translate(-2.92 7.32) rotate(-30)"
      fill="#a67af4"
    />
    <rect
      x={7.9}
      ...
      width={1.98}
      height={9.5}
      transform="translate(23.61 5.82) rotate(90)"
      fill="#773adc"
    />
...
const Memo = memo(SvgAzureExpressrouteCircuits);
export default Memo;
