...
const SvgAzureMachineLearning = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <title>{'Icon-166Artboard 1'}</title>
    <path
      id="bc892891-989d-4c43-80d3-d2b4546a974f"
      d="M15.8,17.5H2.2L1.1,13.4H16.9Z"
      fill="#198ab3"
    />
    <polygon
    ...
    <path
      ...
      d="M15.8,17.5,9.6,11.1l2.6-3,4.7,5.3Z"
      fill="#32bedd"
    />
  </svg>
);
const Memo = memo(SvgAzureMachineLearning);
export default Memo;
