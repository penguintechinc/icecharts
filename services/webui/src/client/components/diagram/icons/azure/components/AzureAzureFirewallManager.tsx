...
const SvgAzureAzureFirewallManager = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="b9eda14d-5018-4069-8461-e9c1522765ff"
        x1={13.45}
        y1={6.3}
        x2={13.45}
        y2={16.46}
    ...
    <g id="be3822ce-a876-4992-8b2c-8f2bcec68a4e">
      ...
      <g>
        <g>
          <path
            d="M14.44,1.52H.61A.58.58,0,0,0,0,2.11V9.22a.58.58,0,0,0,.59.58H8.25V7a.49.49,0,0,1,.34-.47l.13,0a4.89,4.89,0,0,0,3.19-1.16,2.32,2.32,0,0,1,.69-.25A4,4,0,0,1,13.44,5a3.92,3.92,0,0,1,.84.08,2.44,2.44,0,0,1,.74.27V2.11A.58.58,0,0,0,14.44,1.52ZM10.22,7.16V9h4.06V7.16Z"
            fill="#821010"
          />
        ...
        <g>
          ...
          <g>
            <path
              d="M13.44,11.38V6.3c1.93,0,1.33,1.13,3.9,1.2a.26.26,0,0,1,.26.26V11c0,.12,0,.23,0,.34Zm0,0H9.3c.25,2.57,3.32,4.61,4,5l.12,0h0Z"
              fill="url(#b9eda14d-5018-4069-8461-e9c1522765ff)"
            />
            <path
              d="M9.54,7.5c2.57-.07,2-1.2,3.9-1.2v5.08H9.3c0-.11,0-.22,0-.34V7.76A.26.26,0,0,1,9.54,7.5Z"
              fill="#ffd400"
            />
            <path
              d="M17.58,11.38H13.44v5.08h0l.11,0C14.27,16,17.33,14,17.58,11.38Z"
              fill="#ffd400"
            />
          </g>
        </g>
...
const Memo = memo(SvgAzureAzureFirewallManager);
export default Memo;
