...
const SvgAzureDeviceEnrollment = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      d="M9.78,11.41h-2v-2A.47.47,0,0,0,7.33,9H7.17a.47.47,0,0,0-.47.47v2h-2a.47.47,0,0,0-.46.47V12a.47.47,0,0,0,.46.47h2v2a.47.47,0,0,0,.47.46h.16a.47.47,0,0,0,.47-.46v-2h2a.47.47,0,0,0,.47-.47v-.16A.47.47,0,0,0,9.78,11.41Z"
      fill="#fff"
    />
    <rect x={13.72} y={15.96} width={0.86} height={0.73} rx={0.2} fill="#f2f2f2" />
  </svg>
);
const Memo = memo(SvgAzureDeviceEnrollment);
export default Memo;
