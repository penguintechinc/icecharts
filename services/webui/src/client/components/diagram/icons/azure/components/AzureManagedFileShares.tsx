...
const SvgAzureManagedFileShares = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <linearGradient
        ...
        x2={-2149.665}
        y2={1011.114}
        gradientTransform="translate(-2138.383 1025.516) rotate(-180)"
    ...
    <g id="uuid-65a9092c-9c9e-4919-8c4e-13cd4aceb01b">
      <g>
        ...
        <g>
          <path
            d="M15.084,4.814l-6.814-.985h-.138c-.498-.004-.921.363-.986.857l-.256,1.665h9.013v-.404c.088-.537-.276-1.044-.813-1.132-.002,0-.004,0-.006,0Z"
            fill="#a67af4"
          />
          <path
            d="M15.015,5.237l-6.804-.985h-.089c-.284.002-.523.212-.562.493l-.237,1.606h8.106l.069-.463c.047-.312-.168-.603-.481-.65,0,0-.002,0-.002,0Z"
            fill="#fff"
          />
        </g>
        <path
          d="M5.312,5.06h5.966c.077.004.151.035.207.089l.986.985c.054.057.129.089.207.089h4.536c.16,0,.291.126.296.286v7.319c-.005.159-.136.286-.296.286H5.381c-.156.022-.301-.087-.323-.244-.002-.014-.003-.028-.003-.042V5.375c-.012-.156.101-.295.256-.315Z"
...
const Memo = memo(SvgAzureManagedFileShares);
export default Memo;
