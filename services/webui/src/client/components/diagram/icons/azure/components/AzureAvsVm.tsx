...
const SvgAzureAvsVm = (props: SVGProps<SVGSVGElement>) => (
    ...
    <g id="b914d40a-a5c1-44c6-9813-f068fd44847c">
      <g>
        ...
        <g>
          ...
          <polygon
            points="5.998 8.543 8.998 10.297 8.998 6.805 8.994 6.803 5.998 8.543"
            fill="#fff"
          />
        ...
        <path
          d="M12.607,16.428c-1.78-.278-1.85-1.562-1.844-3.63H7.232c0,2.068-.065,3.352-1.844,3.63A1.048,1.048,0,0,0,4.5,17.434h9A1.053,1.053,0,0,0,12.607,16.428Z"
