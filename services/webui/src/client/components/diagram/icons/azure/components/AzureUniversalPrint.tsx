...
const SvgAzureUniversalPrint = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" {...props}>
    ...
    <g id="afb37d11-6e90-4ac0-b9c9-249fa60649c5">
      <path
        d="M17.982,10.118c0-.818-1.193-1.087-1.652-1.717-.632-.867-.7-1.977-1.855-2.166a5.091,5.091,0,0,0-5.244-4.87,5.225,5.225,0,0,0-4.993,3.4A4.822,4.822,0,0,0,0,9.408a4.893,4.893,0,0,0,5.063,4.7c.151,0,.3-.007.446-.019h8.2a.811.811,0,0,0,.216-.032A4.089,4.089,0,0,0,17.982,10.118Z"
      ...
      />
      <path
        d="M7.106,8.18H17.4a.6.6,0,0,1,.6.6v6.1a0,0,0,0,1,0,0H6.507a0,0,0,0,1,0,0v-6.1A.6.6,0,0,1,7.106,8.18Z"
        fill="#5ea0ef"
      />
      ...
      <path
        d="M8.57,12.512h7.367a0,0,0,0,1,0,0v3.823a.3.3,0,0,1-.3.3H8.869a.3.3,0,0,1-.3-.3V12.512A0,0,0,0,1,8.57,12.512Z"
        fill="url(#eda6497f-9c76-477d-ab72-569c0508aebb)"
      />
    </g>
  </svg>
);
const Memo = memo(SvgAzureUniversalPrint);
export default Memo;
