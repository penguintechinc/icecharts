...
const SvgAzureDashboard = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        id="a09b0f0f-3d24-4aad-8fda-73f9dc8561f7"
        x1={9}
        y1={790.787}
        x2={9}
        y2={774.125}
    ...
    <path
      d="M.549,2.636H17.461A.518.518,0,0,1,18,3.125v11.75a.518.518,0,0,1-.539.489H.549A.528.528,0,0,1,0,14.875V3.145a.529.529,0,0,1,.548-.509Z"
      fill="url(#a09b0f0f-3d24-4aad-8fda-73f9dc8561f7)"
    />
    ...
    <polygon
      points="9.117 4.772 6.987 8.562 4.734 6.267 2.412 9.278 2.956 9.705 4.798 7.329 7.136 9.715 9.72 5.119 9.117 4.772"
      fill="#fff"
    />
...
const Memo = memo(SvgAzureDashboard);
export default Memo;
