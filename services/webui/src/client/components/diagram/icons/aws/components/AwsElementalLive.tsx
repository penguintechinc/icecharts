...
const SvgAwsElementalLive = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width="64px"
    height="64px"
    viewBox="0 0 64 64"
  ...
  >
    ...
    <g
      id="Icon-Architecture/48/Arch_AWS-Elemental-Live_48"
      stroke="none"
      strokeWidth={1}
      fill="none"
      fillRule="evenodd"
    >
      ...
      <path
        ...
        id="AWS-Elemental-Live_Icon_48_Squid"
        fill="#FFFFFF"
      />
    </g>
  </svg>
);
const Memo = memo(SvgAwsElementalLive);
export default Memo;
