...
const SvgAwsElementalConductor = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width="64px"
    height="64px"
    viewBox="0 0 64 64"
  ...
  >
    ...
    <g
      id="Icon-Architecture/48/Arch_AWS-Elemental-Conductor_48"
      stroke="none"
      strokeWidth={1}
      fill="none"
      fillRule="evenodd"
    >
      ...
      <path
        ...
        id="AWS-Elemental-Conductor_Icon_48_Squid"
        fill="#FFFFFF"
      />
    </g>
  </svg>
);
const Memo = memo(SvgAwsElementalConductor);
export default Memo;
