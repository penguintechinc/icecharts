...
const SvgAwsReservedInstanceReporting = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width="64px"
    height="64px"
    viewBox="0 0 64 64"
  ...
  >
    ...
    <g
      id="Icon-Architecture/48/Arch_Reserved-Instance-Reporting_48"
      stroke="none"
      strokeWidth={1}
      fill="none"
      fillRule="evenodd"
