...
const SvgGcpSecOps = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g id="art">
      ...
      <path
        className="st2"
        d="M260.2,457.5l-4.1-15.5-5.6-15c1.6-.6,159.8-61.4,159.8-173.9V54h0c17.7,0,32,14.3,32,32v167.1c0,31.8-9.9,62.6-29.4,91.3-15.1,22.4-36.1,43.5-62.2,63-42.6,31.6-86.8,49.1-90.5,50.1h0Z"
      />
      <path
        className="st1"
        d="M250.4,457c-2.5-1-45.5-17.4-89-49.6-26.2-19.4-47.1-40.6-62.2-63-19.5-28.8-29.3-59.5-29.3-91.3s7.2-16,16-16,16,7.2,16,16c0,112.6,158.3,173.4,159.9,174,0,0,0,0,.1,0l35.5,13.6s-15.8,8.3-29.9,14.1c-2.1.9-4.4,1.8-7.1,2.7-4,1.3-9.8-.5-9.8-.5h0Z"
      />
      <path
        className="st4"
        d="M215.3,344l35.4-12.4c2.6-1,75.1-28.8,75.1-77.5v-83.7h-139.3v-32h139.3c8.5,0,16.6,3.3,22.6,9.4,6,6.1,9.4,14.1,9.4,22.6v83.7c0,30.5-17.1,58.9-49.5,82.3-9.6,7-20.3,13.3-31.8,18.9-7.6,3.7-12.2,5.6-15.1,6.5,0,0-1.5.5-2.2.6-.4,0-2,.5-4.9.2-3.2-.4-5.9-1.7-8.4-2.7s-6.1-2.7-9.3-4.2c-10.6-4.9-21.3-11.6-21.3-11.6h0Z"
      />
    </g>
  </svg>
);
const Memo = memo(SvgGcpSecOps);
export default Memo;
