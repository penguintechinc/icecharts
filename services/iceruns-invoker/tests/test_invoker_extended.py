...
class TestIceRunsInvokerErrorHandling:
    ...
    def test_process_task_handles_runtime_error(self, invoker_instance, sample_task_data):
    ...
    def test_process_task_handles_permission_error(self, invoker_instance, sample_task_data):
    ...
    def test_process_task_handles_file_not_found_error(self, invoker_instance, sample_task_data):
    ...
    def test_process_task_saves_large_logs_to_s3(self, invoker_instance, sample_task_data):
        ...
        with patch.object(invoker_instance, '_load_package', return_value=b""):
            with patch.object(invoker_instance, '_extract_package', return_value="/tmp/t"):
                with patch.object(invoker_instance, '_cleanup'):
                    with patch.object(invoker_instance, '_save_execution_logs', return_value="s3://logs/exec-123.log") as mock_save:
                        with patch.object(RuntimeManager, 'get_runtime', return_value=mock_runtime):
                            invoker_instance.process_task(sample_task_data)

        mock_save.assert_called_once()

    def test_process_task_truncates_large_stdout(self, invoker_instance, sample_task_data):
        ...
        with patch.object(invoker_instance, '_load_package', return_value=b""):
            with patch.object(invoker_instance, '_extract_package', return_value="/tmp/t"):
                with patch.object(invoker_instance, '_cleanup'):
                    with patch.object(invoker_instance, '_save_execution_logs', return_value="s3://logs/exec-123.log"):
                        with patch.object(RuntimeManager, 'get_runtime', return_value=mock_runtime):
                            invoker_instance.process_task(sample_task_data)
    ...
    def test_process_task_no_save_logs_when_small(self, invoker_instance, sample_task_data):
        ...
        with patch.object(invoker_instance, '_load_package', return_value=b""):
            with patch.object(invoker_instance, '_extract_package', return_value="/tmp/t"):
                with patch.object(invoker_instance, '_cleanup'):
                    with patch.object(invoker_instance, '_save_execution_logs') as mock_save:
                        with patch.object(RuntimeManager, 'get_runtime', return_value=mock_runtime):
                            invoker_instance.process_task(sample_task_data)

        mock_save.assert_not_called()

    def test_process_task_with_missing_exit_code(self, invoker_instance, sample_task_data):
