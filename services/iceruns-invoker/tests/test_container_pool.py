...
class TestContainerPoolErrors:
    ...
    def test_pool_exhausted_on_get_returns_none(self, container_pool, mock_docker_client):
    ...
    def test_container_not_found_exception_handled(self, container_pool, mock_docker_client):
    ...
    def test_docker_api_error_handled_gracefully(self, container_pool, mock_docker_client):
    ...
    def test_remove_container_handles_docker_error(self, container_pool, mock_docker_client):
    ...
    def test_warmup_on_init_creates_containers(self, container_pool, mock_docker_client):
    ...
    def test_cleanup_removes_only_expired_containers(self, container_pool, mock_docker_client):
        ...
        container_pool.warm_containers[key_old]["last_used"] = (
            datetime.utcnow() - timedelta(seconds=700)
        )
    ...
    def test_shutdown_removes_all_even_on_docker_error(self, container_pool, mock_docker_client):
    ...
    def test_add_and_multiple_get_updates_last_used(self, container_pool, mock_docker_client):
    ...
    def test_container_pool_ttl_boundary_condition(self, container_pool, mock_docker_client):
