...
class TestAuthorizationAndScopes:
    ...
    def test_scope_group_full_access(self, api_client, token_with_scope, sample_function):
    ...
    def test_scope_group_execute_only(self, api_client, token_with_scope, sample_function):
    ...
    def test_admin_can_delete_others_execution(self, api_client, token_with_scope, sample_function):
    ...
    def test_non_admin_cannot_delete_others_execution(self, api_client, token_with_scope, sample_function):
